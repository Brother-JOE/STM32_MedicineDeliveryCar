...
#define POINT_FIT_TIMES 8
#define ERR_FIT_VALUE 4    //mm
#define DEVIATION_TARGET -23
...
extern uint8_t slave_mid_start_flag;
extern uint8_t slave_get_start_flag;
extern uint8_t slave_restart2far_flag;
