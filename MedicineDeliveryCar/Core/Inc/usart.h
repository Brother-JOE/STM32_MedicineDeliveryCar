...
extern uint8_t U4RxBuffer[RXBUFFERSIZE];
extern uint8_t U4RXdata_len;
extern uint8_t u4_aRxBuffer;			
extern uint8_t Uart4_Rx_Cnt;		
extern uint8_t uart4_rxstate;
extern uint8_t uart4_rx_finish;
extern uint8_t uart4_tx_finish;
